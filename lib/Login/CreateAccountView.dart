...
class _GlobalVMailsScreenState extends State<GlobalVMailsScreen> {
  ...
  static const List<String> _rules = [
    'Send free voice message but meet your post-mates first',
    'Long term post, picture and video meet relations application.',
    'Private personal video only, no picture nudity',
    'Respect the opposite user',
  ];

  static const List<String> _agreements = [
    'I agree with privacy policy and the customer service Terms & Conditions',
    'I agree to abide by forum respect levels',
    'I agree to always use correct appropriate language',
