...
class _CreatePostScreenState extends State<CreatePostScreen> {
  ...
  final _locationController =
      TextEditingController(text: 'Addis Abeba, Ethiopia');
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _FormField(
                          ...
                          hint:
                              'Write details about your video chat topic....',
                          maxLines: 4,
                        ),
                        const SizedBox(height: 14),
                        ...
                        ..._subCategories.map((cat) => _SubCategoryRow(
                              label: cat,
        ...
        child: Center(
          child: isUploaded
              ? const Icon(Icons.check_circle,
                  color: Color(0xFF6B2FD9), size: 32)
              : Column(
...
class _StarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
        Offset(size.width * 0.84, size.height * 0.27), 2.0, bright);
    canvas.drawCircle(
        Offset(size.width * 0.13, size.height * 0.61), 1.8, bright);
    canvas.drawCircle(
        Offset(size.width * 0.52, size.height * 0.40), 1.5, bright);
  }
